function [Result] = v20181008_Pinwheel_Identification(OP_MAP)
...
for Ptemp = Pwl
    img_temp = OP_MAP(max(1,Ptemp(2)-3):min(size(OP_MAP,1),Ptemp(2)+3),max(1,Ptemp(1)-3):min(size(OP_MAP,2),Ptemp(1)+3));
    cnt = 0;
