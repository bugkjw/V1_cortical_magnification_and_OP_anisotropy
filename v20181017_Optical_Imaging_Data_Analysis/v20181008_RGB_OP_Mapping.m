function [OP_MAP] = v20181008_RGB_OP_Mapping(res)
%% 1. (R,G,B) Curve for Orientation Mapping
% figure;
% subplot(2,2,1);
...
%% 2. Orientation Mapping, Using Point-Curve Min Dist
...
% 
% clear nearest_ori DATA_MAP_reshape white_mask;
